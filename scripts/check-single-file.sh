...
<file>              path relative to the repo root (e.g. src/rational/foundation.rs)
[function_pattern]  optionally restrict verification to matching functions

examples:
  ./scripts/check-single-file.sh src/rational/foundation.rs
  ./scripts/check-single-file.sh src/rational/division.rs
  ./scripts/check-single-file.sh src/rational/ring_algebra.rs lemma_mul_comm
  ./scripts/check-single-file.sh src/runtime_rational.rs
EOF
  exit 0
fi
...
#   src/rational/foundation.rs  ->  rational::foundation
#   src/rational/mod.rs         ->  rational
